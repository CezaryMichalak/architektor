  ...
  return JSON.stringify(
    {
      ...
      instruction:
        "Wygeneruj pełną analizę ProjectAnalysis jako jeden obiekt JSON. Użyj wyłącznie dozwolonych enumów. recommendedActions dopasuj do projectSubtype. Respektuj ruleBasedSignals (brief, MPZP/wypis, MDCP) — bez sprzeczności w detectedInputs. clarifyingQuestionsAsked: [].",
    },
    null,
    2
  );
